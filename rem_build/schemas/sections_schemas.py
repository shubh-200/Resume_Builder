...
class Education(BaseModel):
    ...
    from_date: str = Field(
        description="The start date of the education period. e.g., Aug 2023")
    to_date: str = Field(
        description="The end date of the education period. e.g., May 2025")
...
class Project(BaseModel):
    ...
    from_date: str = Field(
        description="The start date of the project. e.g. Aug 2023"),
    to_date: str = Field(
        description="The end date of the project. e.g. Nov 2023"),
...
class Experience(BaseModel):
    ...
    from_date: str = Field(
        description="The start date of the employment period. e.g., Aug 2023")
    to_date: str = Field(
        description="The end date of the employment period. e.g., Nov 2025")
...
class ResumeSchema(BaseModel):
    ...
    email: str = Field(
        description="The contact email address of the candidate.")
    media: Media = Field(
