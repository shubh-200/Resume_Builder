...
PROJECTS = """You are going to write a JSON resume section of "Project Experience" for an applicant applying for job posts, but only his own projects

Step to follow:
1. Analyze my project details to match job requirements, don't add any additional projects
2. Create a JSON resume section that highlights strongest matches
3. Optimize JSON section for clarity and relevance to the job description.

Instructions:
1. Focus: Craft three highly relevant project experiences from the user's data that align with the job description.
2. Content:
...
SKILLS = """You are going to write a JSON resume section of "Skills" for an applicant from the user's data applying for job posts.

Step to follow:
1. Analyze my Skills details to match job requirements, don't add any new skills
2. Create a JSON resume section that highlights strongest matches.
3. Optimize JSON section for clarity and relevance to the job description.
...
EXPERIENCE = """You are going to write a JSON resume section of "Work Experience" for an applicant applying for job posts from the user's data.

Step to follow:
1. Analyze my Work details to match job requirements, don't add any false information that was not provided.
2. Create a JSON resume section that highlights strongest matches.
3. Optimize JSON section for clarity and relevance to the job description.
